...
INSERT INTO users (mobile, first_name, middle_name, last_name, email, status) 
VALUES ('+447538521999', '_Daniel', 'IntegrationTest', '_Gorin', 'daniel-integrtest-checkmade@neocortek.net', 0); 
