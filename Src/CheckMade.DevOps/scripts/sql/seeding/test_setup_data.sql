...
user_lukas_de_without_email AS (
...
live_event_X2024 AS (
    INSERT INTO live_events (name, start_date, end_date, venue_id, live_event_series_id, status)
        VALUES ('LiveEvent X 2024',
                ...
                (SELECT id FROM live_event_venue), 
