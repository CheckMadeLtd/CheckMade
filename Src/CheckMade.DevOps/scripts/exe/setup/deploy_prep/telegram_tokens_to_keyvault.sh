...
bots["STG-CHECKMADE-OPERATIONS"]="$STG_CHECKMADE_OPERATIONS_BOT_TOKEN"
...
bots["PRD-CHECKMADE-OPERATIONS"]="$PRD_CHECKMADE_OPERATIONS_BOT_TOKEN"
...
for bot_type in "${!bots[@]}"; do
    ...
    if [ -n "$bot_token" ]; then
          ...
          # This leads to --name = e.g. 'TelegramBotConfiguration--CHECKMADE_OPERATIONS_BOT_TOKEN'
